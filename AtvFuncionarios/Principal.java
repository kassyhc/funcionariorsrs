...
public class Principal {
	...
	public static void main(String[] args) {
		Jornada jornada = new Jornada(1,"Sla","01010101",2, "Jardim Alvoarada");
		System.out.println("\nJornada: ");
		...
		Horista horista = new Horista(1,"Sla","01010101",2, "Jardim Alvoarada");
		System.out.println("\nHorista: ");
		...
		PessoaJuridica pessoaJuridica = new PessoaJuridica(1,"Sla","01010101",2, "Jardim Alvoarada");
		System.out.println("\nPessoaJuridica: ");
